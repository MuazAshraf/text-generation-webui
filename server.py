...
def create_interface():
    ...
    with OpenMonkeyPatch():
        if shared.args.listen:
            shared.gradio['interface'].launch(prevent_thread_lock=True, share=True, server_name='0.0.0.0', server_port=7800, inbrowser=shared.args.auto_launch, auth=auth)
        else:
            shared.gradio['interface'].launch(prevent_thread_lock=True, share=True, server_port=7800, inbrowser=shared.args.auto_launch, auth=auth)
